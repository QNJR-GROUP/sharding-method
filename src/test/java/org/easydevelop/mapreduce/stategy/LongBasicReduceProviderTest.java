...
@SpringBootTest(classes={LongBasicReduceProviderTest.class,TestApplicationConfig.class})
@Configuration
public class LongBasicReduceProviderTest {
	...
	public static class AgTest{
		...
		@MapReduce
		public long listTest2(int value){
			return value;
		}
	}
	...
	public void listTest2(){
		long agTest1 = agTest.listTest2(2);
